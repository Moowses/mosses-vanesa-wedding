  ...
  return (
    <main className="min-h-screen bg-[#F6EFE9] px-4 py-10 md:py-14">
      ...
      <div className="mx-auto w-full max-w-[1100px] bg-[#FBF8F1] shadow-[0_25px_80px_rgba(0,0,0,0.12)] ring-1 ring-black/5">
        ...
        {/* Hero (image-led, inside canvas; soft overlay like reference) */}
        <section id="home" className="relative">
          <Image
            src="/hero-couple.jpg" // placeholder
            alt="Wedding couple"
            width={1700}
            height={850}
            priority
          ...
          {/* Soft overlay (lighter than your old black overlay) */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-6">
              <p className="mb-2 text-[10px] uppercase tracking-[0.35em] text-white/80">
                It’s official, we’re tying the knot.
              </p>
              <h2 className="text-3xl font-light tracking-[0.12em] text-white md:text-4xl">
        ...
        {/* Statement block (centered, big breathing room) */}
          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-start">
            <div>
             <Image
              ...
              height={850}
              priority
              className="h-[320px] w-full object-cover md:h-[520px] lg:h-[600px]"
            />
            </div>
            ...
            <div className="text-[#3a3a3a]">
              <div className="space-y-5">
                <p className="text-sm leading-7 text-[#5b5b5b]">
                  ...
                  on Vanesa, quietly. Extremely quietly. Mostly because he was convinced
                  she was way out of his league. Graduation happened, life got busy, and
                  they went their separate ways thinking that was the end of the story.
                </p>

                <p className="text-sm leading-7 text-[#5b5b5b]">
                  Three years later, destiny did what it does best and slid into Instagram.
                  One follow, one message, and one shocking realization later,
                  <span className="italic">{" "}“Wait… you liked me too back then?”</span>{" "}
                  Suddenly, everything clicked and Mosses realized he had been
                  overthinking since day one.
                </p>

                <p className="text-sm leading-7 text-[#5b5b5b]">
                  Turns out, the problem was never the feelings. It was the timing.
                </p>

                <p className="text-sm leading-7 text-[#5b5b5b]">
                  Lesson learned: if it’s meant to be, no distance, no delay, and not even
                  bad timing can stop it. And now, here we are. Proof that when the time is
                  right, love finds its way.
                </p>
              </div>
            </div>
          </div>
