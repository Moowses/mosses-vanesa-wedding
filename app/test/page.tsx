        ...
        <header className="sticky top-0 z-20 bg-[#FBF8F1]/88 backdrop-blur-md border-b border-black/10">
          <div className="px-6 py-3 md:px-10">
            <div className="flex items-center justify-between gap-4">
              ...
              <nav className="flex flex-wrap items-center justify-center gap-5 text-[11px] uppercase tracking-[0.24em] text-[#7a7a7a]">
                <a className="hover:text-[#C58E86] transition" href="#home">Home</a>
                <a className="hover:text-[#C58E86] transition" href="#story">Story</a>
                <a className="hover:text-[#C58E86] transition" href="#locations">Locations</a>
                <a className="hover:text-[#C58E86] transition" href="#details">Details</a>
                <a className="hover:text-[#C58E86] transition" href="#attire">Attire</a>
                <a className="hover:text-[#C58E86] transition" href="#gallery">Gallery</a>
              </nav>
        ...
        <NavyPanel title="Entourage" subtitle="A special thank you to the people guiding us to this day.">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-white/5 p-7 ring-1 ring-white/10">
              <p className="text-[12px] uppercase tracking-[0.28em] text-white/70">Parents of the Groom</p>
              <p className="mt-4 text-lg text-white/90">—</p>
              <p className="mt-1 text-white/75">Add names here</p>
            </div>
            <div className="rounded-3xl bg-white/5 p-7 ring-1 ring-white/10">
              <p className="text-[12px] uppercase tracking-[0.28em] text-white/70">Parents of the Bride</p>
              <p className="mt-4 text-lg text-white/90">—</p>
              <p className="mt-1 text-white/75">Add names here</p>
            </div>
          </div>

          <div className="mt-6 rounded-3xl bg-white/5 p-7 ring-1 ring-white/10 text-center">
            <p className="text-[12px] uppercase tracking-[0.28em] text-white/70">Principal Sponsors</p>
            <p className="mt-4 text-white/75">
              Add the list here (2 columns later if you want).
            </p>
          </div>
        </NavyPanel>
